...
function ResumePage () {
    return( 
        ...
        <h2>About me</h2>
        <p> I have been working as a disibility support worker for the past 9 years which has been a life enriching and character growing career.<br/>
        ...
        through online study.</p>

        <p> As I completed this course in 2022 as a complete beginner and have since continued working as a support worker while participating in 
            self learning to improve upon my overall proficency in software development.</p>
        <p> My projects have largely been in areas of interest for myself and any cool ideas to motivate myself to practice my C#, database, Python,
            HTML, CSS and Javascript skills.</p>
        <p> During my course I also worked on some database stuff utilising MSSMS.
            ...
            I think this is a form of useful that appeals to me most and the ways I'd want to be useful.</p>
        ...
        <p>
            ...
            I'm very interested in getting real life experience, to see the workflow and software that is utilised in a real work place.
        </p>
        <h2>Projects</h2>
