...
const BinomialProb = lazy(() => import("../Pages/Projects/Calculators/Probability/BinomialProb.jsx"));
const DietLog = lazy(() => import("../Pages/Projects/HealthApp/HealthApp.tsx"));
/*Pages
...
const menulinks = [
    ...
    { Path: "/Projects/*",
      ...
      Submenu: [
          ...
          {Path:"HealthApp/HealthApp.tsx", Element:<DietLog/>, Label:"Diet Log"}
        ]
    }
]

const wideLabel = '☰ Menu' ;
const narrowLabel = '☰';
const navmenu = (
  <nav className="nav">
      ...
      return (
        <li className="menu-items" key={index}>
          <div className="mainlist">  
            ...
            <input className="checkBoxToggle" type="checkbox" name="checkBoxToggle" id={`checkBoxToggle-${index}`} />
            {menulinks.SmallLabel && (
              <>
                <label className="checkBoxLabel down" htmlFor={`checkBoxToggle-${index}`}>{menulinks.SmallLabel[0]}</label>
                <label className="checkBoxLabel up" htmlFor={`checkBoxToggle-${index}`}>{menulinks.SmallLabel[1]}</label>
              </>
            )}
          </div> 
          {menulinks.Submenu && (
            <nav className="submenu">
              {menulinks.Submenu.map((submenuItem, index) => (
                <li className="sublist menu-items" key={index}>
  ...
  return (
    <div className="navpage noScroll">
      <div className="navBar">
        <div className="new">
          <NaviconMenu content={navmenu} wideLabel={wideLabel} narrowLabel={narrowLabel}/>
        </div>
      {/* <svg width="256px" height="38px" viewBox="0 0 256 228" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
          <g>
